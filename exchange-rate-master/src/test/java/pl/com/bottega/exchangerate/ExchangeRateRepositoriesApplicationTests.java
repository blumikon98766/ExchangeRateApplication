...
public class ExchangeRateRepositoriesApplicationTests {
    ...
    public void validationErrorsWhenDefiningRates() throws Exception {
        ExchangeRateRepositories rate = new ExchangeRateRepositories(null, null, null);
        mvc.perform(
                put("/exchange-rate").
                        contentType(MediaType.APPLICATION_JSON).
    ...
    public void invalidCurrencyAndRateWhenDefiningRates() throws Exception {
        ExchangeRateRepositories rate = new ExchangeRateRepositories(null, "invalid", new BigDecimal(-1.0));
        mvc.perform(
                put("/exchange-rate").
                        contentType(MediaType.APPLICATION_JSON).
                        content(objectMapper.writeValueAsString(rate))
    ...
    private void saveExchangeRate(String date, String currency, double amount) throws Exception {
        ExchangeRateRepositories rate = new ExchangeRateRepositories(date, currency, new BigDecimal(amount));
        mvc.perform(
                put("/exchange-rate").
                        contentType(MediaType.APPLICATION_JSON).
                        content(objectMapper.writeValueAsString(rate))
    ...
    class ExchangeRateRepositories {

        private String date;
        private String currency;
        private BigDecimal rate;

        public ExchangeRateRepositories(String date, String currency, BigDecimal rate) {
            this.date = date;
